...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepara e executa a consulta para adicionar o novo processador
    $sql = "INSERT INTO processadores (nome, socket, memoria_max) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssi", $nome, $socket, $memoria_max);

    if ($stmt->execute()) {
        $msg = "Processador adicionado com sucesso!";
    } else {
        $msg = "Erro ao adicionar processador: " . $conn->error;
    }
...
<html>
<head>
    <title>Adicionar Processador</title>
    <style>
        body {
