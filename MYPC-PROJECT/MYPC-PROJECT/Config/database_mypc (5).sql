...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 31/10/2024 às 23:43
...
INSERT INTO `tecnicos` (`idtecnico`, `nome`, `email`, `senha`,  `certificado`, `data_cadastro`) VALUES
(1, 'isaac', '123@gmail', '$2y$10$c5t3pYMzSLs9Sqazz6HRuuJ2YNkRB6vK0OVYdQI0vhCur/PjdxYyq', 'PUC', '2024-10-31 02:32:11'),
(2, 'isaac', 'tt@gmail', '$2y$10$zD3Skw5vxgK.Z74Y2vq76uCIGQX1irj3YyUUA1e8R20JdpUsD8mdO', 'UFMG', '2024-10-31 02:35:39');
...
(1, 'isaac', 'isaac@gmail', '123'),
(2, 'isaac', 'kezend2007@gmail.com', '123'),
(3, 'isaac', '123@gmail.com', '123');
...
CREATE TABLE IF NOT EXISTS `build_pc` (
  ...
  `id_armazenamento` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `fk_armazenamento` (`id_armazenamento`),
...
--
/*
INSERT INTO `build_pc` (`id`, `nome_build`, `id_processador`, `id_placa_mae`, `id_memoria_ram`, `id_placa_video`, `id_fonte`, `preco_total`, `data_criacao`, `id_armazenamento`) VALUES
(22, 'Isaac', 1, 1, 1, 1, 1, 1399.95, '2024-09-03 00:31:51', NULL),
(23, 'PC_GAMER', 2, 2, 2, 2, 1, 1629.95, '2024-09-15 14:17:36', NULL),
(24, 'ola', 1, 1, 1, 1, 1, 1399.95, '2024-09-15 14:32:18', NULL),
(25, 'iiii', 1, 1, 1, 1, 1, 1399.95, '2024-09-15 14:32:47', NULL);*/
...
ALTER TABLE `build_pc`
  ...
  ADD CONSTRAINT `fk_armazenamento` FOREIGN KEY (`id_armazenamento`) REFERENCES `armazenamento` (`id`),
  ADD CONSTRAINT `fk_fonte` FOREIGN KEY (`id_fonte`) REFERENCES `fonte` (`id`),
  ADD CONSTRAINT `fk_memoria_ram` FOREIGN KEY (`id_memoria_ram`) REFERENCES `memoria_ram` (`id`),
  ADD CONSTRAINT `fk_placa_mae` FOREIGN KEY (`id_placa_mae`) REFERENCES `placa_mae` (`id`),
  ADD CONSTRAINT `fk_placa_video` FOREIGN KEY (`id_placa_video`) REFERENCES `placa_video` (`id`),
  ADD CONSTRAINT `fk_processador` FOREIGN KEY (`id_processador`) REFERENCES `processador` (`id`),
...
/*ALTER TABLE `mensagem`
  ADD CONSTRAINT `idusuario` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`),
  ADD CONSTRAINT `idusuario` FOREIGN KEY (`idtecnico`) REFERENCES `tecnicos` (`idtecnico`);*/
