...
*/    
    ...
    ?>
    <form action="index.php?action=cadastro_user" method="post">
         <label>Nome</label>
         <input type="text" id = "nome" name = "nome" placeholder="Digite o seu nome e o sobrenome"><br><br>

         <label>Email</label>
         <input type="text" id = "email" name = "email" placeholder="Digite o seu email"><br><br>

         <label>Usuario</label>
         <input type="text" id = "usuario" name = "usuario" placeholder="Digite o usuario"><br><br>
