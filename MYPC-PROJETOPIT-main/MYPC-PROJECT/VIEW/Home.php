<?php
 $identificacao = "SELECT idusuario FROM usuarios WHERE logado = 1"
?>
...
<body>
    <header>
        ...
        <a href="index.php?action=deslogar_user&idusuario=$identificacao">Deslogar</a>
        <a href="index.php?action=cadastro_user">Criar conta</a>
    </header>
    <main>
    ...
    <a href="VIEW/PagSuporte.php">
        ...
        <div class="overlay">Contatar Suporte</div>
            ...
            <div class="service">
                ...
                <div class="overlay">Gerenciar Builds</div>
            </div>
            <div class="service">
                ...
                <div class="overlay">Criar Builds</div>
            </div>
        </div>
    </main>
